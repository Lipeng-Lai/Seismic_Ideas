...
from data.build_data_1Channel import *
...
def main(config):
    ...
    # ============================================Data loader============================================
    image_path1 = '/root/deeplearning/data/image'
    image_path2 = '/root/deeplearning/data/multiple'
    
    label_path1 = '/root/deeplearning/data/output'
